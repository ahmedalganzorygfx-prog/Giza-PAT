...
# 2️⃣ عن الفرع
  ...
  st.markdown("""
  ### 🏛️ التأسيس والانطلاقة (2017)
  أُنشئ فرع الأكاديمية المهنية للمعلمين بمحافظة الجيزة في عام **2017** ليكون الحاضنة الرئيسية لتطوير وتمكين الكوادر التعليمية والتربوية بالمحافظة، وتقديم الخدمات الاعتمادية والتدريبية وفق أعلى معايير الجودة.

  ---

  ### 📜 مرحلة البناء والتأسيس (2017 – 2023)
  شهدت الفترة من **2017 حتى 2023** إرساء القواعد التنظيمية والإدارية للفرع تحت قيادة **الأستاذة / أمل عبد المقصود** (مدير الفرع)، وبمعاونة فريق عمل متميز في قسم تكنولوجيا المعلومات (IT) ضم كلاً من:
  * **أ . أحمد حسني الجنزوري** (عضو تكنولوجيا المعلومات IT)
  * **أ . خالد عبد الحكيم هارون** (عضو تكنولوجيا المعلومات IT)

  ---

  ### 🚀 مرحلة التطوير والتحول الرقمي (2023 – حتى الآن)
  مع بداية عام **2023**، انطلقت مرحلة جديدة ترتكز على **الميكنة والتحول الرقمي للخدمات**، برئاسة **الأستاذ / أحمد حسني الجنزوري** مديراً للفرع، وفريق عمل متميز يتكون من:
  * **أ . خالد عبد الحكيم هارون** (مسئول الموارد البشرية وتكنولوجيا المعلومات IT)
  * **أ . أحمد محمد عمر** (مسئول التنمية المهنية والاعتماد)
